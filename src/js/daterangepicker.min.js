...
! ( function( t, e ) {
	if ( 'function' === typeof define && define.amd ) {
		...
		let a = 'undefined' !== typeof window ? window.jQuery : void 0; a || ( a = require( 'jquery' ) ).fn || ( a.fn = {} ); const i = 'undefined' !== typeof window && void 0 !== window.moment ? window.moment : require( 'moment' ); module.exports = e( i, a );
	} else {
		t.daterangepicker = e( t.moment, t.jQuery );
	}
}( this, function( t, e ) {
	const a = function( a, i, s ) {
		if ( this.parentEl = 'body', this.element = e( a ), this.startDate = t().startOf( 'day' ), this.endDate = t().endOf( 'day' ), this.minDate = ! 1, this.maxDate = ! 1, this.maxSpan = ! 1, this.autoApply = ! 1, this.singleDatePicker = ! 1, this.showDropdowns = ! 1, this.minYear = t().subtract( 100, 'year' ).format( 'YYYY' ), this.maxYear = t().add( 100, 'year' ).format( 'YYYY' ), this.showWeekNumbers = ! 1, this.showISOWeekNumbers = ! 1, this.showCustomRangeLabel = ! 0, this.timePicker = ! 1, this.timePicker24Hour = ! 1, this.timePickerIncrement = 1, this.timePickerSeconds = ! 1, this.linkedCalendars = ! 0, this.autoUpdateInput = ! 0, this.alwaysShowCalendars = ! 1, this.ranges = {}, this.opens = 'right', this.element.hasClass( 'pull-right' ) && ( this.opens = 'left' ), this.drops = 'down', this.element.hasClass( 'dropup' ) && ( this.drops = 'up' ), this.buttonClasses = 'btn btn-sm', this.applyButtonClasses = 'btn-primary', this.cancelButtonClasses = 'btn-default', this.locale = { direction: 'ltr', format: t.localeData().longDateFormat( 'L' ), separator: ' - ', applyLabel: 'Apply', cancelLabel: 'Cancel', weekLabel: 'W', customRangeLabel: 'Custom Range', daysOfWeek: t.weekdaysMin(), monthNames: t.monthsShort(), firstDay: t.localeData().firstDayOfWeek() }, this.callback = function() {}, this.isShowing = ! 1, this.leftCalendar = {}, this.rightCalendar = {}, 'object' === typeof i && null !== i || ( i = {} ), 'string' === typeof ( i = e.extend( this.element.data(), i ) ).template || i.template instanceof e || ( i.template = '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>' ), this.parentEl = i.parentEl && e( i.parentEl ).length ? e( i.parentEl ) : e( this.parentEl ), this.container = e( i.template ).appendTo( this.parentEl ), 'object' === typeof i.locale && ( 'string' === typeof i.locale.direction && ( this.locale.direction = i.locale.direction ), 'string' === typeof i.locale.format && ( this.locale.format = i.locale.format ), 'string' === typeof i.locale.separator && ( this.locale.separator = i.locale.separator ), 'object' === typeof i.locale.daysOfWeek && ( this.locale.daysOfWeek = i.locale.daysOfWeek.slice() ), 'object' === typeof i.locale.monthNames && ( this.locale.monthNames = i.locale.monthNames.slice() ), 'number' === typeof i.locale.firstDay && ( this.locale.firstDay = i.locale.firstDay ), 'string' === typeof i.locale.applyLabel && ( this.locale.applyLabel = i.locale.applyLabel ), 'string' === typeof i.locale.cancelLabel && ( this.locale.cancelLabel = i.locale.cancelLabel ), 'string' === typeof i.locale.weekLabel && ( this.locale.weekLabel = i.locale.weekLabel ), 'string' === typeof i.locale.customRangeLabel ) ) {
			( f = document.createElement( 'textarea' ) ).innerHTML = i.locale.customRangeLabel; var n = f.value; this.locale.customRangeLabel = n;
			...
			for ( let r = this.locale.firstDay; r > 0; ) {
				this.locale.daysOfWeek.push( this.locale.daysOfWeek.shift() ), r--;
			}
		} let o, l, h; if ( void 0 === i.startDate && void 0 === i.endDate && e( this.element ).is( ':text' ) ) {
			const c = e( this.element ).val(),
				d = c.split( this.locale.separator ); o = l = null, 2 == d.length ? ( o = t( d[ 0 ], this.locale.format ), l = t( d[ 1 ], this.locale.format ) ) : this.singleDatePicker && '' !== c && ( o = t( c, this.locale.format ), l = t( c, this.locale.format ) ), null !== o && null !== l && ( this.setStartDate( o ), this.setEndDate( l ) );
			...
			for ( h in i.ranges ) {
				o = 'string' === typeof i.ranges[ h ][ 0 ] ? t( i.ranges[ h ][ 0 ], this.locale.format ) : t( i.ranges[ h ][ 0 ] ), l = 'string' === typeof i.ranges[ h ][ 1 ] ? t( i.ranges[ h ][ 1 ], this.locale.format ) : t( i.ranges[ h ][ 1 ] ), this.minDate && o.isBefore( this.minDate ) && ( o = this.minDate.clone() ); let m = this.maxDate; if ( this.maxSpan && m && o.clone().add( this.maxSpan ).isAfter( m ) && ( m = o.clone().add( this.maxSpan ) ), m && l.isAfter( m ) && ( l = m.clone() ), ! ( this.minDate && l.isBefore( this.minDate, this.timepicker ? 'minute' : 'day' ) || m && o.isAfter( m, this.timepicker ? 'minute' : 'day' ) ) ) {
					var f; ( f = document.createElement( 'textarea' ) ).innerHTML = h; n = f.value; this.ranges[ n ] = [ o, l ];
				}
			} let p = '<ul>'; for ( h in this.ranges ) {
	...
	}; return a.prototype = { constructor: a, setStartDate( e ) {
		...
		if ( this.timePicker ) {
			let t, e, a, i; if ( this.endDate ) {
				if ( t = parseInt( this.container.find( '.left .hourselect' ).val(), 10 ), e = parseInt( this.container.find( '.left .minuteselect' ).val(), 10 ), isNaN( e ) && ( e = parseInt( this.container.find( '.left .minuteselect option:last' ).val(), 10 ) ), a = this.timePickerSeconds ? parseInt( this.container.find( '.left .secondselect' ).val(), 10 ) : 0, ! this.timePicker24Hour ) {
					'PM' === ( i = this.container.find( '.left .ampmselect' ).val() ) && t < 12 && ( t += 12 ), 'AM' === i && 12 === t && ( t = 0 );
				}
			} else if ( t = parseInt( this.container.find( '.right .hourselect' ).val(), 10 ), e = parseInt( this.container.find( '.right .minuteselect' ).val(), 10 ), isNaN( e ) && ( e = parseInt( this.container.find( '.right .minuteselect option:last' ).val(), 10 ) ), a = this.timePickerSeconds ? parseInt( this.container.find( '.right .secondselect' ).val(), 10 ) : 0, ! this.timePicker24Hour ) {
		...
		let i,
			...
			i[ D ] = [];
		} let g = p - u + this.locale.firstDay + 1; g > p && ( g -= 7 ), u == this.locale.firstDay && ( g = p - 6 ); for ( var y = t( [ f, m, g, 12, o, l ] ), k = ( D = 0, 0 ), b = 0; D < 42; D++, k++, y = t( y ).add( 24, 'hour' ) ) {
		...
		}'left' == a ? this.leftCalendar.calendar = i : this.rightCalendar.calendar = i; let v = 'left' == a ? this.minDate : this.startDate,
			C = this.maxDate,
			Y = ( 'left' == a ? this.startDate : this.endDate, this.locale.direction, '<table class="table-condensed">' ); Y += '<thead>', Y += '<tr>', ( this.showWeekNumbers || this.showISOWeekNumbers ) && ( Y += '<th></th>' ), v && ! v.isBefore( i.firstDay ) || this.linkedCalendars && 'left' != a ? Y += '<th></th>' : Y += '<th class="prev available"><span></span></th>'; let w = this.locale.monthNames[ i[ 1 ][ 1 ].month() ] + i[ 1 ][ 1 ].format( ' YYYY' ); if ( this.showDropdowns ) {
			...
			}A += '</select>'; for ( var N = '<select class="yearselect">', E = I; E <= M; E++ ) {
			...
			const W = this.startDate.clone().add( this.maxSpan ).endOf( 'day' ); C && ! W.isBefore( C ) || ( C = W );
		} for ( b = 0; b < 6; b++ ) {
			Y += '<tr>', this.showWeekNumbers ? Y += '<td class="week">' + i[ b ][ 0 ].week() + '</td>' : this.showISOWeekNumbers && ( Y += '<td class="week">' + i[ b ][ 0 ].isoWeek() + '</td>' ); for ( k = 0; k < 7; k++ ) {
				const O = []; i[ b ][ k ].isSame( new Date, 'day' ) && O.push( 'today' ), i[ b ][ k ].isoWeekday() > 5 && O.push( 'weekend' ), i[ b ][ k ].month() != i[ 1 ][ 1 ].month() && O.push( 'off', 'ends' ), this.minDate && i[ b ][ k ].isBefore( this.minDate, 'day' ) && O.push( 'off', 'disabled' ), C && i[ b ][ k ].isAfter( C, 'day' ) && O.push( 'off', 'disabled' ), this.isInvalidDate( i[ b ][ k ] ) && O.push( 'off', 'disabled' ), i[ b ][ k ].format( 'YYYY-MM-DD' ) == this.startDate.format( 'YYYY-MM-DD' ) && O.push( 'active', 'start-date' ), null != this.endDate && i[ b ][ k ].format( 'YYYY-MM-DD' ) == this.endDate.format( 'YYYY-MM-DD' ) && O.push( 'active', 'end-date' ), null != this.endDate && i[ b ][ k ] > this.startDate && i[ b ][ k ] < this.endDate && O.push( 'in-range' ); const H = this.isCustomDate( i[ b ][ k ] ); ! 1 !== H && ( 'string' === typeof H ? O.push( H ) : Array.prototype.push.apply( O, H ) ); let j = '',
					R = ! 1; for ( D = 0; D < O.length; D++ ) {
		...
		if ( 'right' != t || this.endDate ) {
			let e, a, i,
				s = this.maxDate; if ( ! this.maxSpan || this.maxDate && ! this.startDate.clone().add( this.maxSpan ).isBefore( this.maxDate ) || ( s = this.startDate.clone().add( this.maxSpan ) ), 'left' == t ) {
				a = this.startDate.clone(), i = this.minDate;
			} else if ( 'right' == t ) {
				a = this.endDate.clone(), i = this.startDate; const n = this.container.find( '.drp-calendar.right .calendar-time' ); if ( '' != n.html() && ( a.hour( isNaN( a.hour() ) ? n.find( '.hourselect option:selected' ).val() : a.hour() ), a.minute( isNaN( a.minute() ) ? n.find( '.minuteselect option:selected' ).val() : a.minute() ), a.second( isNaN( a.second() ) ? n.find( '.secondselect option:selected' ).val() : a.second() ), ! this.timePicker24Hour ) ) {
					const r = n.find( '.ampmselect option:selected' ).val(); 'PM' === r && a.hour() < 12 && a.hour( a.hour() + 12 ), 'AM' === r && 12 === a.hour() && a.hour( 0 );
				}a.isBefore( this.startDate ) && ( a = this.startDate.clone() ), s && a.isAfter( s ) && ( a = s.clone() );
			}e = '<select class="hourselect">'; for ( var o = this.timePicker24Hour ? 0 : 1, l = this.timePicker24Hour ? 23 : 12, h = o; h <= l; h++ ) {
				let c = h; this.timePicker24Hour || ( c = a.hour() >= 12 ? 12 == h ? 12 : h + 12 : 12 == h ? 0 : h ); var d = a.clone().hour( c ),
			...
			}e += '</select> ', e += ': <select class="minuteselect">'; for ( h = 0; h < 60; h += this.timePickerIncrement ) {
				...
				e += ': <select class="secondselect">'; for ( h = 0; h < 60; h++ ) {
				...
				e += '<select class="ampmselect">'; let p = '',
		...
		let t,
			a = { top: 0, left: 0 },
			i = e( window ).width(); this.parentEl.is( 'body' ) || ( a = { top: this.parentEl.offset().top - this.parentEl.scrollTop(), left: this.parentEl.offset().left - this.parentEl.scrollLeft() }, i = this.parentEl[ 0 ].clientWidth + this.parentEl.offset().left ), t = 'up' == this.drops ? this.element.offset().top - this.container.outerHeight() - a.top : this.element.offset().top + this.element.outerHeight() - a.top, this.container.css( { top: 0, left: 0, right: 'auto' } ); const s = this.container.outerWidth(); if ( this.container[ 'up' == this.drops ? 'addClass' : 'removeClass' ]( 'drop-up' ), 'left' == this.opens ) {
			const n = i - this.element.offset().left - this.element.outerWidth(); s + n > e( window ).width() ? this.container.css( { top: t, right: 'auto', left: 9 } ) : this.container.css( { top: t, right: n, left: 'auto' } );
			...
			var r; ( r = this.element.offset().left - a.left ) + s > e( window ).width() ? this.container.css( { top: t, left: 'auto', right: 0 } ) : this.container.css( { top: t, left: r, right: 'auto' } );
		}
	}, show( t ) {
		...
		const a = e( t.target ); 'focusin' == t.type || a.closest( this.element ).length || a.closest( this.container ).length || a.closest( '.calendar-table' ).length || ( this.hide(), this.element.trigger( 'outsideClick.daterangepicker', this ) );
	}, showCalendars() {
		this.container.addClass( 'show-calendar' ), this.move(), this.element.trigger( 'showCalendar.daterangepicker', this );
	}, hideCalendars() {
		this.container.removeClass( 'show-calendar' ), this.element.trigger( 'hideCalendar.daterangepicker', this );
	}, clickRange( t ) {
		const e = t.target.getAttribute( 'data-range-key' ); if ( this.chosenLabel = e, e == this.locale.customRangeLabel ) {
			this.showCalendars();
		} else {
			const a = this.ranges[ e ]; this.startDate = a[ 0 ], this.endDate = a[ 1 ], this.timePicker || ( this.startDate.startOf( 'day' ), this.endDate.endOf( 'day' ) ), this.alwaysShowCalendars || this.hideCalendars(), this.clickApply();
		}
	}, clickPrev( t ) {
		...
		if ( e( t.target ).hasClass( 'available' ) ) {
			const a = e( t.target ).attr( 'data-title' ),
				i = a.substr( 1, 1 ),
				s = a.substr( 3, 1 ),
		...
		if ( e( t.target ).hasClass( 'available' ) ) {
			let a = e( t.target ).attr( 'data-title' ),
				i = a.substr( 1, 1 ),
				s = a.substr( 3, 1 ),
				...
				if ( this.timePicker ) {
					var r = parseInt( this.container.find( '.left .hourselect' ).val(), 10 ); if ( ! this.timePicker24Hour ) {
						'PM' === ( h = this.container.find( '.left .ampmselect' ).val() ) && r < 12 && ( r += 12 ), 'AM' === h && 12 === r && ( r = 0 );
					} var o = parseInt( this.container.find( '.left .minuteselect' ).val(), 10 ); isNaN( o ) && ( o = parseInt( this.container.find( '.left .minuteselect option:last' ).val(), 10 ) ); var l = this.timePickerSeconds ? parseInt( this.container.find( '.left .secondselect' ).val(), 10 ) : 0; n = n.clone().hour( r ).minute( o ).second( l );
				} this.endDate = null, this.setStartDate( n.clone() );
			} else if ( ! this.endDate && n.isBefore( this.startDate ) ) {
				this.setEndDate( this.startDate.clone() );
			} else {
				if ( this.timePicker ) {
					var h; r = parseInt( this.container.find( '.right .hourselect' ).val(), 10 ); if ( ! this.timePicker24Hour ) {
						'PM' === ( h = this.container.find( '.right .ampmselect' ).val() ) && r < 12 && ( r += 12 ), 'AM' === h && 12 === r && ( r = 0 );
					} o = parseInt( this.container.find( '.right .minuteselect' ).val(), 10 ); isNaN( o ) && ( o = parseInt( this.container.find( '.right .minuteselect option:last' ).val(), 10 ) ); l = this.timePickerSeconds ? parseInt( this.container.find( '.right .secondselect' ).val(), 10 ) : 0; n = n.clone().hour( r ).minute( o ).second( l );
				} this.setEndDate( n.clone() ), this.autoApply && ( this.calculateChosenLabel(), this.clickApply() );
			} this.singleDatePicker && ( this.setEndDate( this.startDate ), this.timePicker || this.clickApply() ), this.updateView(), t.stopPropagation();
		}
	}, calculateChosenLabel() {
		let t = ! 0,
			e = 0; for ( const a in this.ranges ) {
			if ( this.timePicker ) {
				const i = this.timePickerSeconds ? 'YYYY-MM-DD HH:mm:ss' : 'YYYY-MM-DD HH:mm'; if ( this.startDate.format( i ) == this.ranges[ a ][ 0 ].format( i ) && this.endDate.format( i ) == this.ranges[ a ][ 1 ].format( i ) ) {
		...
		let a = e( t.target ).closest( '.drp-calendar' ).hasClass( 'left' ),
			i = a ? 'left' : 'right',
		...
		let a = e( t.target ).closest( '.drp-calendar' ),
			i = a.hasClass( 'left' ),
			s = parseInt( a.find( '.hourselect' ).val(), 10 ),
			n = parseInt( a.find( '.minuteselect' ).val(), 10 ); isNaN( n ) && ( n = parseInt( a.find( '.minuteselect option:last' ).val(), 10 ) ); const r = this.timePickerSeconds ? parseInt( a.find( '.secondselect' ).val(), 10 ) : 0; if ( ! this.timePicker24Hour ) {
			const o = a.find( '.ampmselect' ).val(); 'PM' === o && s < 12 && ( s += 12 ), 'AM' === o && 12 === s && ( s = 0 );
		} if ( i ) {
			const l = this.startDate.clone(); l.hour( s ), l.minute( n ), l.second( r ), this.setStartDate( l ), this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format( 'YYYY-MM-DD' ) == l.format( 'YYYY-MM-DD' ) && this.endDate.isBefore( l ) && this.setEndDate( l.clone() );
		} else if ( this.endDate ) {
			const h = this.endDate.clone(); h.hour( s ), h.minute( n ), h.second( r ), this.setEndDate( h );
		} this.updateCalendars(), this.updateFormInputs(), this.renderTimePicker( 'left' ), this.renderTimePicker( 'right' );
	}, elementChanged() {
		if ( this.element.is( 'input' ) && this.element.val().length ) {
			let e = this.element.val().split( this.locale.separator ),
				a = null,
		...
		if ( this.element.is( 'input' ) && this.autoUpdateInput ) {
			let t = this.startDate.format( this.locale.format ); this.singleDatePicker || ( t += this.locale.separator + this.endDate.format( this.locale.format ) ), t !== this.element.val() && this.element.val( t ).trigger( 'change' );
		}
	}, remove() {
		this.container.remove(), this.element.off( '.daterangepicker' ), this.element.removeData();
	} }, e.fn.daterangepicker = function( t, i ) {
		const s = e.extend( ! 0, {}, e.fn.daterangepicker.defaultOptions, t ); return this.each( function() {
			const t = e( this ); t.data( 'daterangepicker' ) && t.data( 'daterangepicker' ).remove(), t.data( 'daterangepicker', new a( t, s, i ) );
		} ), this;
	}, a;
} ) );
