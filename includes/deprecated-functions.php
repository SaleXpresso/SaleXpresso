...
if ( ! function_exists( 'sxp_do_deprecated_action' ) ) {
	/**
...
if ( ! function_exists( 'sxp_deprecated_function' ) ) {
	/**
...
if ( ! function_exists( 'sxp_deprecated_hook' ) ) {
	/**
...
if ( ! function_exists( 'sxp_caught_exception' ) ) {
	/**
...
if ( ! function_exists( 'sxp_doing_it_wrong' ) ) {
	/**
...
if ( ! function_exists( 'sxp_deprecated_argument' ) ) {
	/**
