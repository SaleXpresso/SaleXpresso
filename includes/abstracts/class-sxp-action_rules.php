...
//			'coupon-code'        => [
//				'label'   => __( 'Coupon Code', 'salexpresso' ),
//				'data'    => 'order.coupon',
//				'help'    => '',
//				'exclude' => [],
//			],
...
//			'tagged-width'       => [
//				'label'   => __( 'Tagged With', 'salexpresso' ),
//				'data'    => 'user.tags',
//				'help'    => '',
//				'exclude' => [],
//			],
	...
	protected function build_expression( $rule ) {
		...
		// return expression
		// str_replace has issues with array.
...
// End of file class-sxp-action_rules.php.
